...
public class DartProjectileFly extends Object {
...
//    float offsetX, offsetY, offsetZ;
    ...
    public DartProjectileFly(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color) {
