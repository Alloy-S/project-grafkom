...
public class NinjaMonkeyEar2 extends Object {
    float radiusX, radiusY, radiusZ;
    int sectorCount, stackCount;
//    public float offsetX, offsetY, offsetZ;

    public NinjaMonkeyEar2(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color) {
...
//        children
        ...
        getChildObject().add(new NinjaMonkeyEarInside2(
                Arrays.asList(
