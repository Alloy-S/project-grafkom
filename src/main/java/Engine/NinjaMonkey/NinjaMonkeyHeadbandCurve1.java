...
public class NinjaMonkeyHeadbandCurve1 extends Object {
    float radius;
    float offsetX, offsetY, offsetZ;

    List<List<Vector3f>> totalVertices = new ArrayList<>();
    public NinjaMonkeyHeadbandCurve1(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color) {
