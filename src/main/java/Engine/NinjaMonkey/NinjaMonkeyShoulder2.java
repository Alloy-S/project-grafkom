...
import Engine.EngineerMonkey.EngineerMonkeyElbow1;
...
public class NinjaMonkeyShoulder2 extends Object {
    float radiusX, radiusY, radiusZ;
    int sectorCount, stackCount;
//    float offsetX, offsetY, offsetZ;

    public NinjaMonkeyShoulder2(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color) {
...
//        getChildObject().get(0).rotateObject((float) Math.toRadians(15), 0f, 0f, 1f);
        ...
        getChildObject().get(0).getChildObject().add(new NinjaMonkeyElbow2(
                Arrays.asList(
                        new ShaderModuleData
                                ("resources/shaders/scene.vert"
                                        , GL_VERTEX_SHADER),
