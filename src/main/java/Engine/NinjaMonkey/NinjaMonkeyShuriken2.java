...
public class NinjaMonkeyShuriken2 extends Object {
    //    float offsetX, offsetY, offsetZ;
    Vector3f center, radius;

    public NinjaMonkeyShuriken2(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius) {
