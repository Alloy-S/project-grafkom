...
public class NinjaMonkeyShuriken3 extends Object {
    //    float offsetX, offsetY, offsetZ;
    Vector3f center, radius;

    public NinjaMonkeyShuriken3(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius) {
        ...
        this.offsetY = 0.4f;
        this.offsetZ = 0.5f;
        rotateObject((float) Math.toRadians(270), 1f,0f, 0f);
