...
public class NinjaMonkeyShuriken4 extends Object {
    //    float offsetX, offsetY, offsetZ;
    Vector3f center, radius;

    public NinjaMonkeyShuriken4(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius) {
        ...
        this.offsetY = 0.4f;
        this.offsetZ = 0.5f;
        rotateObject((float) Math.toRadians(90f), 1f,0f, 0f);
